...
void DXModels::InitializeModels(LPDIRECT3DDEVICE9 devcon)
{
	VOID* pVoid;
	...
	devcon->CreateVertexBuffer(24 * sizeof(DXTexture::TEXTUREVERTEX), 0, TEXTUREFVF, D3DPOOL_MANAGED, &vBuffer, NULL);
	vBuffer->Lock(0, 0, (void**)&pVoid, 0);
	memcpy(pVoid, vertices, sizeof(vertices));
	vBuffer->Unlock();

	devcon->CreateVertexBuffer(4 * sizeof(DXTexture::TEXTUREVERTEX), 0, TEXTUREFVF, D3DPOOL_MANAGED, &terrainBuffer, NULL);
